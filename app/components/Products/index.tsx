...
const Products = ({
  ...
  const withStars = ProductsList.map((card: any) => {
    ...
    <div id="products" className="w-screen">
      ...
      <section className="block pt-8 h-auto sm:block md:hidden lg:hidden relative bg-[#141516]">
        ...
        <div className="flex flex-col items-center m-4 sm:m-4">
          ...
          <p
            className="font-bold text-3xl sm:text-3xl lg:text-4xl bg-clip-text text-transparent bg-gradient-to-b from-green-400 to-blue-500 pointer-events-none pb-16 pt-8 !text-start"
